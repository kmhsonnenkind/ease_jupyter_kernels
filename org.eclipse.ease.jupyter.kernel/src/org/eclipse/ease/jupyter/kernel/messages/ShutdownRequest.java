...
public class ShutdownRequest extends Content {
	...
	@JsonCreator
	public ShutdownRequest(@JsonProperty(value = "restart", required = true) final Boolean restart) {
